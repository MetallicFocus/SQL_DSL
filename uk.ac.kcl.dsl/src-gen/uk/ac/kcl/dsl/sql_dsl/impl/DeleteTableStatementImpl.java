 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.kcl.dsl.sql_dsl.impl.DeleteTableStatementImpl#getX <em>X</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeleteTableStatementImpl extends StatementImpl implements DeleteTableStatement
{
  ...
  {
    return Sql_dslPackage.Literals.DELETE_TABLE_STATEMENT;
  }
  ...
  public NotificationChain basicSetX(FromAndWhereClauses newX, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Sql_dslPackage.DELETE_TABLE_STATEMENT__X, oldX, newX);
  ...
  public void setX(FromAndWhereClauses newX)
  {
    if (newX != x)
    {
      ...
      if (x != null)
        msgs = ((InternalEObject)x).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Sql_dslPackage.DELETE_TABLE_STATEMENT__X, null, msgs);
      if (newX != null)
        msgs = ((InternalEObject)newX).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Sql_dslPackage.DELETE_TABLE_STATEMENT__X, null, msgs);
      msgs = basicSetX(newX, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Sql_dslPackage.DELETE_TABLE_STATEMENT__X, newX, newX));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Sql_dslPackage.DELETE_TABLE_STATEMENT__X:
